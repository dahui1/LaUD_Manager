...
function cqlexec(type){
    ...
    if(typestring==="goto"){
     ...
     $.ajax({  
        url:'CQLexec.action',  
        type:'POST',  
        data:{"cqlstring":cqlstring ,"typestring":typestring,"current":current,"total":total,"gotopage":gotopage},  
        dataType:'json',  
        success:function (data) {
        ...
        if(err===null){
            if(isnull!==null){
                ...
                if(typestring==="firstpage"){
                   ...
                   else{document.getElementById("currentpage").innerHTML=data.currentpage;}
                }
          ...
          else {document.getElementById("errorinfo").innerHTML="CQL EXECUTE SUCCESSFULLY";}
        }
        else {document.getElementById("errorinfo").innerHTML=data.errorinfo;}
      }
    });
}